...
- 멘토링 ✔️  
  - 내 지도 교수 함게 만나기
  - 대학원 방문 및 선배 만나기
    나누었던 이야기 : 졸업을 위해 학교 생활 하면서 열심히 해야 하는 것들, 현재 개발분야 채용 시장의 분위기, 대학원생의 일상.

    1. 졸업을 위해 학교 생활 하면서 열심히 해야 하는 것들
      - 필수 교양 수강하기
      - 전공 수업 열심히 듣기
      - 알고리즘 문제 많이 풀기
    2. 현재 개발분야 채용 시장의 분위기
      - 백엔드와 프론트엔드는 항상 수요가 있어 왔음.
      - AI 스타트업은 인재를 많이 뽑고 있으나 대단한 실력은 요하지 않음.
      - 개발 분야가 아니더라도 꽤 많은 선택지가 있음.
    3. 대학원생의 일상
      - 크게 수업을 듣거나 연구를 한다.
      - 수업은 한 학기에 6학점을 들으며 대부분 절대평가 방식으로 평가한다.
      - 연구하고 싶은 분야가 있으면, 해당 분야에 대해 잘 알고계신 교수님을 찾아뵙는다.
